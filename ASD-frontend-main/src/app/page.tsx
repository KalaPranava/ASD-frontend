...
<Link href="/register" className="synaptic-pulse px-8 py-4 rounded-full text-on-primary-fixed font-bold text-lg hover:scale-105 transition-all shadow-[0_10px_30px_rgba(91,140,255,0.1)] hover:shadow-[0_0_25px_rgba(91,140,255,0.45)] flex items-center gap-2">
                    Start Analysing EEGs
                    <span className="material-symbols-outlined" data-icon="analytics">analytics</span>
</Link>
<a href="#about" className="px-8 py-4 rounded-full border border-outline/20 text-on-surface font-semibold text-lg hover:bg-surface-container-high transition-all hover:shadow-[0_0_20px_rgba(91,140,255,0.45)] flex items-center gap-2">
...
<stop offset="0%" stopColor="#5b8cff" stopOpacity={1}></stop>
<stop offset="100%" stopColor="#0b1020" stopOpacity={1}></stop>
</linearGradient>
</defs>
</svg>
</div>
...
{/* Feature 1 */}
<div className="relative overflow-hidden group p-8 rounded-lg bg-surface-container-high hover:bg-surface-variant transition-all duration-500 hover:-translate-y-2 border border-transparent hover:border-primary/10 hover:shadow-[0_10px_40px_-15px_rgba(91,140,255,0.3)]">
<span className="absolute bottom-0 left-0 w-full h-[3px] bg-primary scale-x-0 group-hover:scale-x-100 transition-transform duration-700 ease-out origin-center shadow-[0_0_25px_8px_rgba(91,140,255,0.45)]"></span>
...
<Link href="/register" className="synaptic-pulse px-10 py-4 rounded-full text-on-primary-fixed font-bold text-lg hover:scale-105 transition-all hover:shadow-[0_0_25px_rgba(91,140,255,0.45)]">
                        Get Started Now
                    </Link>
</div>
</div>
