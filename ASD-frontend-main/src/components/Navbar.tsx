...
const Navbar: FC = () => {
  ...
  return (
    <nav className="fixed top-0 w-full z-50 glass-nav shadow-[0_4px_20px_rgba(91,140,255,0.04)]">
      <div className="flex justify-between items-center max-w-7xl mx-auto px-6 h-20">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link href="/login" className="hidden sm:inline-flex items-center justify-center px-6 py-2.5 rounded-full border border-outline/20 text-on-surface hover:bg-surface-bright transition-all hover:shadow-[0_0_20px_rgba(91,140,255,0.45)]">
            Sign In
          </Link>
        </div>
      </div>
