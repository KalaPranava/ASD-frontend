...
export default function AuthForm({ defaultTab = "signin" }: { defaultTab?: "signin" | "register" }) {
  ...
  return (
    <div className="flex flex-col min-h-screen relative overflow-hidden bg-surface text-on-surface">
      ...
      <div className="absolute bottom-1/4 -right-24 w-64 h-64 bg-secondary/5 rounded-full blur-[100px] pointer-events-none"></div>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 sm:px-12 py-12 z-10 w-full">
        <div className="w-full max-w-[540px] space-y-10">
          ...
          {/* Tab Switcher */}
          <div className="flex justify-center space-x-16 relative border-b border-outline-variant/30 mb-8">
            <button
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    <input
                      ...
                      className="w-full bg-surface-container-highest/90 border border-transparent rounded-2xl py-4 px-6 text-on-surface placeholder:text-outline focus:ring-1 focus:ring-primary/35 focus:border-primary/25 transition-all outline-none"
                      placeholder="Sarah"
                    />
                  </div>
                </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                <input
                  ...
                  className="w-full bg-surface-container-highest/90 border border-transparent rounded-2xl py-4 px-6 text-on-surface placeholder:text-outline focus:ring-1 focus:ring-primary/35 focus:border-primary/25 transition-all outline-none pr-12"
                  placeholder="••••••••••••"
                />
                <button
                  type="button"
            ...
            <button
              disabled={isLoading}
              type="submit"
              className="w-full text-on-primary-fixed py-4 px-6 rounded-full font-headline font-bold text-[1.75rem] leading-none flex items-center justify-center gap-3 bg-[#2f4f9e] hover:bg-[#2f4f9e] shadow-none hover:shadow-none hover:scale-100 transition-none active:scale-100 disabled:opacity-70 disabled:hover:scale-100 border border-[#415ea9]"
            >
              {isLoading ? (
                <>
          ...
          <div className="relative py-4">
            ...
            <div className="relative flex justify-center text-xs uppercase tracking-tight">
        ...
        {/* Compact supporting quote */}
        <div className="pt-8 mt-4 w-full max-w-md border-t border-outline-variant/30">
          <div className="text-center space-y-2">
            <p className="text-on-surface-variant italic font-body text-sm leading-relaxed">
              "The AI precision has completely transformed our workflow."
            </p>
            <p className="font-headline font-semibold text-primary text-[11px] uppercase tracking-[0.2em]">
      ...
      {/* Footer */}
      <footer className="p-8 flex flex-col sm:flex-row justify-center items-center gap-6 text-[10px] uppercase tracking-widest text-outline z-10 opacity-80">
