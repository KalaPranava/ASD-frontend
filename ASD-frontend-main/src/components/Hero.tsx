      ...
      <div className="relative z-10 max-w-5xl mt-[-5%]">
        <div className="flex flex-col items-start gap-10">
          ...
          <div className="flex gap-4 mt-4">
            ...
            <button className="bg-gradient-to-r from-secondary to-primary-container text-on-primary-fixed shadow-[0_4px_20px_rgba(91,140,255,0.04),0_20px_40px_rgba(0,0,0,0.4)] rounded-full px-8 py-4 font-bold hover:scale-[1.02] transition-transform text-lg">
              Initialize Console
            </button>
